model RideModel_6DOF_DamperCalculation
...
equation
  ...
  z_dotdot*mass_sprung = kfl*(z_tyre_fl - (z + theta*a)) + kfr*(z_tyre_fr - (z + theta*a)) + krl*(z_tyre_rl - (z - theta*b)) + krr*(z_tyre_rr - (z - theta*b)) + damper_fl_force/damper_fl_velocity*(z_tyre_fl_dot - (z_dot + theta_dot*a)) + damper_fr_force/damper_fr_velocity*(z_tyre_fr_dot - (z + theta_dot*a)) + damper_rl_force/damper_rl_velocity*(z_tyre_rl_dot - (z - theta*b)) + crr*(z_tyre_rr_dot - (z_dot - theta_dot*b));

  theta_dotdot*Iyy = kfl*a*(z_tyre_fl - (z + theta*a)) + kfr*a*(z_tyre_fr - (z + theta*a)) - krl*b*(z_tyre_rl - (z - theta*b)) - krr*b*(z_tyre_rr - (z - theta*b)) + damper_fl_force/damper_fl_velocity*a*(z_tyre_fl_dot - (z_dot + theta_dot*a)) + damper_fr_force/damper_fr_velocity*a*(z_tyre_fr_dot - (z_dot + theta_dot*a)) - damper_rl_force/damper_rl_velocity*b*(z_tyre_rl_dot - (z_dot - theta_dot*b)) - crr*b*(z_tyre_rr_dot - (z_dot - theta_dot*b));
  ...
  z_tyre_fl_dotdot*mass_unsprung_f = k_tyre_f*(z_road_fl - z_tyre_fl) + kfl*(z + theta*a - z_tyre_fl) + damper_fl_force/damper_fl_velocity*(z_dot + theta_dot*a - z_tyre_fl_dot);

  z_tyre_fr_dotdot*mass_unsprung_f = k_tyre_f*(z_road_fr - z_tyre_fr) + kfr*(z + theta*a - z_tyre_fr) + damper_fr_force/damper_fr_velocity*(z_dot + theta_dot*a - z_tyre_fr_dot);

  z_tyre_rl_dotdot*mass_unsprung_r = k_tyre_r*(z_road_rl - z_tyre_rl) + krl*(z - theta*b - z_tyre_rl) + damper_rl_force/damper_rl_velocity*(z_dot - theta_dot*b - z_tyre_rl_dot);
...
end RideModel_6DOF_DamperCalculation;
